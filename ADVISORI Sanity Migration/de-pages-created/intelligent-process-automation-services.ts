...
const run = async () => {
  try {
    console.log('Creating Intelligent Process Automation Services page...')

    const intelligentProcessAutomationServicesData = {
      _type: 'servicePage',
      _id: 'intelligent-process-automation-services',
      title: 'Intelligent Process Automation Services',
      slug: {
        _type: 'slug',
        current: 'digitale-transformation/prozessautomatisierung/intelligent-automation/intelligent-process-automation-services'
      },
      parent: {
        _type: 'reference',
      ...
      seo: {
        _type: 'seo',
        title: 'Intelligent Process Automation Services - IPA & KI-gestützte Prozessoptimierung | ADVISORI',
        description: 'Professionelle Intelligent Process Automation Services für digitale Prozessexzellenz. IPA-Implementierung, Process Mining, Workflow-Automatisierung, Business Process Management und EU AI Act konforme Prozessautomatisierung.',
        keywords: 'Intelligent Process Automation, IPA, Process Mining, Workflow Automation, Business Process Management, BPM, Prozessautomatisierung, Digital Process Excellence, EU AI Act, Process Optimization'
      },
      heroSection: {
        _type: 'object',
        heroImage: {
          _type: 'image',
          alt: 'Intelligent Process Automation Services - IPA und KI-gestützte Prozessoptimierung für digitale Excellence'
        },
        tagline: 'Intelligent Process Automation Excellence für digitale Prozessführerschaft',
        heading: 'Intelligent Process Automation Services',
        description: 'Intelligent Process Automation Services transformieren traditionelle Geschäftsprozesse in strategisch orchestrierte, KI-gestützte Automatisierungsökosysteme. Durch nahtlose Integration von Process Mining, Workflow-Automatisierung, Business Process Management und Cognitive Computing schaffen wir prozesszentrierte Automatisierungslösungen, die operative Exzellenz mit strategischer Innovation optimal vereinen und dabei EU AI Act Compliance gewährleisten.',
        benefits: [
          {
            _type: 'object',
            _key: generateKey('benefit', 1),
            text: 'Process Mining und Discovery für datengetriebene Prozessoptimierung und Automatisierungspotenzial-Identifikation'
          },
          {
            _type: 'object',
      ...
      overview: {
        _type: 'object',
        heading: 'Intelligent Process Automation Services - Strategic Process Excellence für moderne Enterprise-Transformation',
        description: 'Intelligent Process Automation Services sind das strategische Fundament für prozesszentrierte digitale Transformation. Sie transformieren fragmentierte, manuelle Geschäftsprozesse in kohärente, KI-gestützte Automatisierungsökosysteme, die nicht nur operative Effizienz maximieren, sondern auch als strategische Enabler für Prozessexzellenz, Geschäftsmodell-Innovation und nachhaltige Wettbewerbsvorteile fungieren.',
        points: [
          {
            _type: 'object',
        ...
        alert: {
          title: 'Intelligent Process Automation als strategischer Process-Excellence-Accelerator',
          content: 'Intelligent Process Automation Services werden zum strategischen Differentiator für prozesszentrierte digitale Transformation, operative Exzellenz und moderne Enterprise-Innovation – weit über traditionelle Workflow-Automatisierung hinaus.'
        },
        whyUs: {
          title: 'Warum Intelligent Process Automation mit ADVISORI',
          points: [
            {
              _type: 'object',
              _key: generateKey('whyUs', 1),
              text: 'Umfassende IPA-Expertise von Process Mining bis KI-gestützte Prozessoptimierung'
            },
            {
              _type: 'object',
        ...
        additionalInfo: 'Intelligent Process Automation Services ermöglichen es Organisationen, die volle Power moderner Prozessautomatisierung für strategische Geschäftstransformation zu nutzen. Die richtige IPA-Strategie wird zum Wettbewerbsvorteil in einer zunehmend prozessorientierten Enterprise-Welt.',
        serviceDescription: 'Unser Intelligent Process Automation Service umfasst die vollständige Transformation von manuellen Prozesslandschaften zu strategischen KI-gestützten Automatisierungsökosystemen. Wir entwickeln maßgeschneiderte IPA-Strategien, die perfekt zu Ihren Geschäftsprozessen, Technologie-Infrastrukturen und Compliance-Anforderungen passen.',
        servicePoints: [
          {
            _type: 'object',
      ...
      approach: {
        _type: 'object',
        title: 'Unser Ansatz zu Intelligent Process Automation Services',
        description: 'Wir verfolgen einen ganzheitlichen und prozesszentrierten Ansatz zu Intelligent Process Automation, der moderne Automatisierungstechnologien optimal nutzt und gleichzeitig strategische Process Excellence ermöglicht.',
        points: [
          {
            _type: 'object',
          ...
          },
          {
            ...
            text: 'Phasenweise IPA-Implementierung mit kontinuierlicher Optimierung und Performance-Monitoring'
          },
          {
            _type: 'object',
      ...
      testimonial: {
        ...
        name: 'Asan Stefanski',
        position: 'Director',
        quote: 'Intelligent Process Automation Services sind das strategische Fundament für prozesszentrierte digitale Transformation. Wir transformieren fragmentierte manuelle Geschäftsprozesse in strategisch orchestrierte KI-gestützte Automatisierungsökosysteme, die nicht nur operative Prozessexzellenz gewährleisten, sondern auch als strategische Enabler für Geschäftsmodell-Innovation, Workflow-Optimierung und nachhaltige Wettbewerbsvorteile fungieren.'
      },
      services: [
        {
          _type: 'object',
        ...
        },
        {
          ...
          title: 'Workflow-Automatisierung und BPM-Integration',
        ...
        },
        {
          ...
          title: 'KI-gestützte Prozessoptimierung und Analytics',
        ...
        },
        {
          ...
          title: 'Process Integration und Enterprise-Connectivity',
        ...
        },
        {
          ...
          title: 'Process Governance und Compliance Management',
        ...
        },
        {
          ...
          title: 'Change Management und Process Adoption',
    ...
    transaction.createOrReplace(intelligentProcessAutomationServicesData)
    console.log('Committing transaction...')
    await transaction.commit()

    console.log('✅ Intelligent Process Automation Services page created successfully')
  } catch (error) {
