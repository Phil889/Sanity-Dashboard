...
const run = async () => {
  try {
    console.log('Creating SBOM CRA page...')
    ...
    const sbomCraData = {
      ...
      slug: {
        _type: 'slug',
        current: 'regulatory-compliance-management/cra-cyber-resilience-act/sbom-cra'
      },
      parent: {
        _type: 'reference',
      ...
      seo: {
        _type: 'seo',
        title: 'SBOM CRA - Software Bill of Materials für Cyber Resilience Act | ADVISORI',
        ...
        keywords: 'SBOM CRA, Software Bill of Materials, CRA Compliance, Supply Chain Security, Vulnerability Management, SPDX, CycloneDX, SBOM Automation, CRA SBOM Requirements'
      },
      heroSection: {
        _type: 'object',
        heroImage: {
          _type: 'image',
          alt: 'SBOM CRA Implementation'
        },
    ...
    transaction.createOrReplace(sbomCraData)
    console.log('Committing transaction...')
    await transaction.commit()

    console.log('✅ SBOM CRA page created successfully')
  } catch (error) {
