...
const run = async () => {
  try {
    console.log('Creating ISO 27001 Zertifizierung page...')

    const iso27001ZertifizierungData = {
      _type: 'servicePage',
      _id: 'iso-27001-zertifizierung',
      title: 'ISO 27001 Zertifizierung',
      slug: {
        _type: 'slug',
        current: 'regulatory-compliance-management/standards-frameworks/iso-27001/iso-27001-zertifizierung'
      },
      parent: {
        _type: 'reference',
        _ref: 'iso-27001'
      ...
      seo: {
        _type: 'seo',
        title: 'ISO 27001 Zertifizierung & Audit Support | ADVISORI',
        description: 'Professionelle ISO 27001 Zertifizierungsbegleitung von der Vorbereitung bis zur erfolgreichen Zertifizierung. Audit-Support, Gap-Analyse und kontinuierliche Compliance-Sicherung.',
        keywords: 'ISO 27001 Zertifizierung, ISO 27001 Audit, Zertifizierungsvorbereitung, ISMS Zertifizierung, Audit Support, Compliance Zertifizierung, Informationssicherheit Zertifikat'
      },
      heroSection: {
        _type: 'object',
        heroImage: {
          _type: 'image',
          alt: 'ISO 27001 Zertifizierung und Audit Support'
        },
        tagline: 'Ihr Weg zur erfolgreichen ISO 27001 Zertifizierung',
        heading: 'ISO 27001 Zertifizierung',
        description: 'Erreichen Sie Ihre ISO 27001 Zertifizierung mit unserer bewährten Expertise und umfassenden Begleitung. Von der strategischen Vorbereitung über die Audit-Unterstützung bis zur nachhaltigen Compliance-Sicherung.',
        benefits: [
          {
            _type: 'object',
            _key: generateKey('benefit', 1),
            text: 'Strukturierte Zertifizierungsvorbereitung mit bewährten Methoden'
          },
          {
            _type: 'object',
            _key: generateKey('benefit', 2),
            text: 'Professionelle Audit-Begleitung und Unterstützung'
          },
          {
            _type: 'object',
          ...
          },
          {
            ...
            text: 'Maximierung der Erfolgswahrscheinlichkeit bei minimalen Risiken'
          }
        ]
      },
      overview: {
        ...
        description: 'Die ISO 27001 Zertifizierung ist mehr als ein Compliance-Nachweis – sie ist ein strategisches Investment in Vertrauen, Wettbewerbsfähigkeit und operative Exzellenz. Unsere umfassende Zertifizierungsbegleitung gewährleistet nicht nur den erfolgreichen Abschluss des Zertifizierungsprozesses, sondern schafft auch die Grundlage für langfristige Informationssicherheit und kontinuierliche Verbesserung.',
        points: [
          {
            _type: 'object',
            _key: generateKey('point', 1),
            text: 'Strategische Zertifizierungsplanung mit optimaler Ressourcenallokation und Zeitplanung'
          },
          {
            _type: 'object',
        ...
        alert: {
          title: 'Zertifizierungserfolg durch Expertise',
    ...
    transaction.createOrReplace(iso27001ZertifizierungData)
    console.log('Committing transaction...')
    await transaction.commit()

    console.log('✅ ISO 27001 Zertifizierung page created successfully')
  } catch (error) {
