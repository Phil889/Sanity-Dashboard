...
import { faqsBatch1 } from './mifid-best-execution-en-faqs-batch1'
import { faqsBatch2 } from './mifid-best-execution-en-faqs-batch2'
import { faqsBatch3 } from './mifid-best-execution-en-faqs-batch3'
import { faqsBatch4 } from './mifid-best-execution-en-faqs-batch4'
import { faqsBatch5 } from './mifid-best-execution-en-faqs-batch5'
...
const mifidBestExecutionEn = {
  ...
  slug: {
    _type: 'slug',
    current: 'regulatory-compliance-management/mifid/mifid-best-execution-en'
  },
  language: 'en',
  __i18n_lang: 'en',
  __i18n_base: {
...
export async function importMifidBestExecutionEn() {
  console.log('🚀 Starting MiFID Best Execution EN import...')
  console.log(`📊 Total FAQs to import: ${allFaqs.length}`)
  
  try {
    const result = await client.createOrReplace(mifidBestExecutionEn)
    console.log('✅ MiFID Best Execution EN page created successfully!')
