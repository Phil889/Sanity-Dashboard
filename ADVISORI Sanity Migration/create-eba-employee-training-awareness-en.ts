...
async function createEbaEmployeeTrainingEn() {
  console.log('Creating EBA Employee Training & Awareness EN document...')
  ...
  try {
    ...
    console.log('✅ Successfully created EBA Employee Training & Awareness EN document')
